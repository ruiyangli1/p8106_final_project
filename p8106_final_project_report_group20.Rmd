...
author: "Zhourong Li (zl2977), Cong Zhang (cz2612), Ruiyang Li (rl3034)"
date: "5/13/2021"
output: 
  pdf_document: 
...
model_compare = 
  ...
  geom_point(data = test_error, 
             ...
             shape = 20, size = 2) + 
  labs(caption = paste("Orange point: RMSE from test data","\n", "Black hollow point: mean RMSE from training data"))
```
...
```{r var_distn, fig.height= 8.5,fig.width= 10}
var_distn
```
\begin{center}
...
```{r ice_curve, fig.height= 8.5,fig.width= 10}
