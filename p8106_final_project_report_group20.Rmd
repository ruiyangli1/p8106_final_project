...
```
\center __Figure 1__ Tuning Lamda of Lasso Model \center
...
```
\center __Figure 1__ Tuning alpha and Lamda of Elastic Net Model \center
...
```
\center __Figure 1__ Tuning Optimal Components of PCR Model \center
...
```
\center __Figure 1__ Tuning Optimal Components of PLS Model \center
...
```
\center __Figure 1__ Tuning MARS Model \center
...
```
\center __Figure 1__ Tuning Complexity Parameter of Regression Tree Model \center
...
ctree.fit$bestTune
```
\center __Figure 1__ Tuning Mincriterion of Conditional Inference Tree Model \center
...
rf.fit$bestTune
```
\center __Figure 1__ Tuning Random Forest Model \center
...
gbm.fit$bestTune
```
\center __Figure 1__ Tuning Boosting Model \center
